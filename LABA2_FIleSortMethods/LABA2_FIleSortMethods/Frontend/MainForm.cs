        ...
        private void ButtonRun_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (radioButtonSingle.Checked)
                {
                    ...
                    ExternalSorter.Sort( sortMethod, out int comparisons, out int swaps);
                    sw.Stop();

                    var resultForm = new ResultForm(sortMethod.ToString(), sw.ElapsedMilliseconds, comparisons, swaps, ExternalSorter.GetLastSortedArray());
